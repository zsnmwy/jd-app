...
mui('#footer').on('tap','a',function(e){
	let prePage = plus.webview.currentWebview().opener();
	let urlStr = this.name;
	// let items = mui("#footer a");
	// for(let i in items){
	// 	items[i].className = "mui-tab-item";
	// }
	// mui.fire(prePage, 'refresh',{url:urlStr});
	// mui.openWindow({
	// 	id: urlStr,
	// 	url: urlStr,
	// 	createNew: false
...
window.addEventListener("refresh", function(data) {
	let urlName = data.detail.url;
	console.log("事件监听："+urlName)
    let items = mui("#footer a");
    for(let i in items){
    	items[i].className = "mui-tab-item";
    }
